...
class UserManagement:
    ...
    def delete_employee(self):
        ...
        try:
            for employee in employees:
                if employee._id == employee_to_delete:
                    found = True
                    confirm = input(f"\nAre you sure you want to confirm employee >> name: {employee._name}, ID: {employee._id} (yes/no): ")
                   
                    if confirm.lower() == "yes" or confirm.lower() == "y":
                       db.delete(employee)
                       print(f"Employee '{employee._name}' deleted successfully!")
    ...
    def display_employee_details(self, employee: object) -> dict:
        return {"name": employee._name, "number": employee._number, "role": employee.get_role(), "id": employee._id}


    def update_employee_data(self, employees: list):
        ...
        try:
            for employee in employees:
                if employee_to_update == employee._id:
